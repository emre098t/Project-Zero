                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        for (int j = 0; j < evo.Digivolutions; j++)
                        {
                            ...
                            for (int k = 0; k < 10; k++) // -> Change to 9 for ver 128
                            {
                                ...
                                int key = read.ReadInt(); //GET KEY
                                int value = read.ReadInt(); //Value of the key
                                //Console.WriteLine(key + " = KEY");
                                //Console.WriteLine(value + " = VALUE");
                                if (line.Line.ContainsKey(key) && key.Equals(0))
                                    continue;
                                line.Line.Add(key, value);
                            ...
                            new System.IO.StreamWriter(@"C:\Users\Lazarevic\Desktop\DigiEvoTEst.txt", true))
                            {
                                file.WriteLine("{0} > {1} |> {2} > {3} > {4}", evo.digiId, evo.Digivolutions, line.digiId, line.iLevel);
                            }*/
                        }
