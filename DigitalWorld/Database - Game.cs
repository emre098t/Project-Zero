                    ...
                    using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM `chars` WHERE `characterId` = @char", con))
                    {
                        ...
                        using (MySqlDataReader dr = cmd.ExecuteReader(System.Data.CommandBehavior.SingleRow))
                        {
                            ...
                            if (dr.HasRows && dr.Read())
                            {
                                ...
                                try { tamer.Warehouse = ItemList.Deserialize((byte[])dr["Warehouse"]); }
                                catch { tamer.Warehouse = new ItemList(245); }
                        ...
                        using (MySqlDataReader dr = cmd.ExecuteReader())
                        {
                            if (dr.HasRows)
                            {
                                if (dr.Read())
                                {
                                    ...
                                    digimon.Stats.BL = (short)(int)dr["BL"];
            ...
            try
            {
                ...
                if (lastChar != -1)
                {
                    ...
                    using (MySqlConnection con = Connect())
                    {
                        ...
                        qry.Add("WarehouseLimit", Tamer.WarehouseSize);
                        ...
                        qry.Add("Warehouse", Tamer.Warehouse.Serialize());
