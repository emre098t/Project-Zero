...
namespace Digital_World.Packets
{
    ...
    public interface IPacketServerIP
    {
        byte[] ToArray2();
    }


    public interface IPacketCharInfo
    {
        byte[] ToArrayCharInfo();
    }
    ...
    public class Packet : IPacket
    {
        ...
        public byte[] ToArrayCharInfo()
        {
            return packet.FinalizeCharInfo();
        }
    ...
    public class PacketCharInfo : IPacketCharInfo
    {
        internal PacketWriter packet;

        public PacketCharInfo()
        {
            packet = new PacketWriter();
        }
