    ...
    public partial class Yggdrasil
    {
        ...
        public void Command(Client client, string[] cmd)
        {
            ...
            switch (cmd[0])
            {
                ...
                Digimon m = Tamer.Partner;
                Console.WriteLine(m.CurrentForm);
                ...
                /*case "item":
                    {
                        ...
                        Console.WriteLine("CHECK: " + ((e.Modifier ^ 1) / 2));
                ...
                /*case "sk2":
                    {
                        ...
                        Console.WriteLine(Tamer.DigimonHandle.ToString());
                        client.Send(new UseSkill(Tamer.DigimonHandle, Tamer.DigimonHandle, skill, 1, 9999));
                        break;
                    }*/
                /*case "list":
                    {
                ...
                case "tamer.setav":
                    {
                        ...
                        switch (cmd[1].ToLower())
                        {
                            ...
                            case "Warehouse":
                                Tamer.WarehouseSize = value; break;
                            case "size":
                                ActiveMap.Send(new ChangeSize(Tamer.TamerHandle, value, 0));
                                break;
                            case "bits":
                                Tamer.Money = Tamer.Money + value;
                                client.Send(new MoneyUpdater(Tamer.TamerHandle,Tamer.Money));
                                break;
                        }
                ...
                case "digimon.setav":
                    {
                        ...
                        switch (cmd[1].ToLower())
                        {
                            ...
                            case "level":
                                ...
                                Console.WriteLine(partner.Handle + " " + "HANDLE");
                                Console.WriteLine(partner.Model + " " + "MODEL");
                                Console.WriteLine(Tamer.Partner.Handle + " " + "Partner Handle");
                                client.Send(new UpdateLevel(Tamer.DigimonHandle, (byte)value));
                                break;
                            case "exp":
